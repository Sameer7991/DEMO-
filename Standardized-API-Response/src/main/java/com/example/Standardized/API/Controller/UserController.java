package com.example.Standardized.API.Controller;
...
import com.example.Standardized.API.Service.UserService;
...
public class UserController {
	...
	@PostMapping
	public ResponseEntity<ApiResponse<UserResponseDTO>> addUser(@Valid @RequestBody UserRegister dto, HttpServletRequest request){
