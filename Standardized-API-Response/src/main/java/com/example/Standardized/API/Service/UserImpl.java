...
import com.example.Standardized.API.Common.Status;
...
import com.example.Standardized.API.Repository.UserRepo;
...
public class UserImpl implements UserService {
    ...
    @Override
    public ResponseEntity<ApiResponse<UserResponseDTO>> addUser(UserRegister dto, HttpServletRequest request) {
    ...
    private boolean userRepo(String email) {
